...
ones). Reference: @C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/molsim/Desktop/LLM4POL/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/molsim/Desktop/LLM4POL/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/templates/spec.md.
