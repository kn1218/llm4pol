...
<required_reading>
@C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/references/ai-frameworks.md
@C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/molsim/Desktop/LLM4POL/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/molsim/Desktop/LLM4POL/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/molsim/Desktop/LLM4POL/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/molsim/Desktop/LLM4POL/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/molsim/Desktop/LLM4POL/.claude/agents/gsd-eval-planner.md for instructions.
