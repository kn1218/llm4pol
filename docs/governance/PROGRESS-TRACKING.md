...
| ADR-0006 rework (plan 02-06) | **Done 2026-09-24.** A missing `tacticity` is resolved from its labelled twin before the candidate identity is taken: 554 empty rows to 312 `none` / 182 `atactic` / 60 `unknown`, candidates 78,676 to 78,375, replicates pooled (multi-row candidates 12,983 to 13,014). Validator report republished; D-11 promoted; `02-06-VERIFICATION.md` 21/21 with the numbers re-derived outside the package |
